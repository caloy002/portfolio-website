...
export default function SocialLinks({ links, className = '', size = 'md' }) {
  const btnSize = size === 'lg' ? 'h-12 w-12' : 'h-11 w-11'
    ...
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      {links.map((social, i) => (
        <motion.a
          ...
          target="_blank"
          rel="noreferrer"
          className={`social-glass-btn touch-target flex ${btnSize} items-center justify-center rounded-xl`}
